...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * //
    ...
    dimensionedVector BubbleRadius
    (
    ...
    forAll(alpha1, cellI)
    {
        ...
        scalar phi = Foam::atan(x[2]/x[0]);
        scalar center = Foam::sqrt(magSqr(BubbleCenter.value()[0]*Foam::cos(phi))+magSqr(BubbleCenter.value()[2]*Foam::sin(phi)));
